...
# Eager loading why we need eager loading in asyn sqlalchemy

# What is asyncontext manager and how it is different from normal context manager

# How fastapi optimises performance even for sync routes
